...
import { Button, Panel, SelectField, Switch, useToast } from "../../../components/ui";
...
import { CodexProviderOptions } from "../components/CodexProviderOptions";
...
function CodexEnhancement() {
  ...
  return <Panel className="settings-panel codex-enhancement-panel">
    ...
    <div className="codex-enhancement-row">
      ...
      <Switch
        checked={preserveOfficialLogin}
        aria-label="非接管切换时保留官方登录"
        disabled={saving}
        onCheckedChange={() => void togglePreservation()}
      />
    </div>
  </Panel>;
}
