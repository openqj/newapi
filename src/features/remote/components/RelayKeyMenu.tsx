...
export function RelayKeyMenu({ position, rows, saving, menuRef, onSelect }: { position: { top: number; left: number; width: number }; rows: KeyRow[]; saving: boolean; menuRef: Ref<HTMLDivElement>; onSelect: (value: string) => void }) {
