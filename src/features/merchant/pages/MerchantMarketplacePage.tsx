...
function ContactDialog({ merchant, onClose }: { merchant: MerchantRateShare; onClose: () => void }) {
  return <FormDialog title={merchant.merchantName} description={merchant.description || "暂无商家说明"} ariaLabel="商家充值联系" onClose={onClose} footer={<button type="button" className="button-secondary" onClick={onClose}>关闭</button>}>
