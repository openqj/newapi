...
use commands::personal_center::{
    claim_merchant_free_account, delete_admin_merchant_free_account,
    ...
    import_merchant_free_accounts, list_admin_merchant_free_accounts,
    ...
    save_admin_merchant_free_account, save_admin_merchant_profile,
...
pub(crate) fn application_builder() -> tauri::Builder<tauri::Wry> {
    tauri::Builder::default().invoke_handler(tauri::generate_handler![
        ...
        list_admin_merchant_free_accounts,
        save_admin_merchant_free_account,
        delete_admin_merchant_free_account,
